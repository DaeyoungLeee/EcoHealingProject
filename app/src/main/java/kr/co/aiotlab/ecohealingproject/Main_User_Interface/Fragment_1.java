...
public class Fragment_1 extends Fragment{
    ...
    private TextView nowCity, now_small_dust, now_big_dust,
            getCDStext, txt_getCo2;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Thread_MQTT thread_mqtt = new Thread_MQTT();
        thread_mqtt.start();
    ...
    private void getAddress(final double longitude, final double latitude) {
        ...
        new Thread(new Runnable() {
            String clientId = "sljtn4ofyf";// 애플리케이션 클라이언트 아이디값";
            String clientSecret = "0wrk05jut5rHVj2zUpLdbnpNgzk0m2Up9FX4BQSH";// 애플리케이션 클라이언트 시크릿값";
            String json = null;
    ...
    public class Thread_MQTT extends Thread implements Runnable {

        String clientId = MqttClient.generateClientId();
        final MqttAndroidClient client =
                new MqttAndroidClient(getContext(), "tcp://222.113.57.108:1883",
                        clientId);
