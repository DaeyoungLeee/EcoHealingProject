package kr.co.aiotlab.ecohealingproject.Fragment4_LineChart;
...
public class LinechartSensor4 extends Fragment implements View.OnClickListener {
    ...
    public static Fragment newInstance() {
        LinechartSensor4 f = new LinechartSensor4();
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.layout_sensor4, container, false);

        mChart = view.findViewById(R.id.linechart_sensor4);
    ...
    private void showLineChartData() {
        new Thread(new Runnable() {
            @Override
            public void run() {
                humidRef = mDatabase.getReference("MQTT_Humidity_day_" + year + month);
