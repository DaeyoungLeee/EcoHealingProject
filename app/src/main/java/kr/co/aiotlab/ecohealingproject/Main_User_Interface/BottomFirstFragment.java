...
import kr.co.aiotlab.ecohealingproject.SearchCity;
import kr.co.aiotlab.ecohealingproject.ThresholdBrightness;
import kr.co.aiotlab.ecohealingproject.ThresholdTemperature;

import static kr.co.aiotlab.ecohealingproject.Main_User_Interface.MainActivity.dust;
import static kr.co.aiotlab.ecohealingproject.Main_User_Interface.MainActivity.humi;
import static kr.co.aiotlab.ecohealingproject.Main_User_Interface.MainActivity.temp;
...
public class BottomFirstFragment extends Fragment implements View.OnClickListener {
    ...
    private TextView weather_state, nowTemperature, nowHumidity, nowCity, now_small_dust, now_big_dust,
            getCDStext, searchCity, txt_getCo2;
    private ImageView weather_icon, th_brightness, th_temp;
    private FirebaseDatabase mDatabase;

    public static TextView getTempText, getHumidityText;
    ...
    public void findWeather() {
        // 지역 설정된 값 가져오기
        SharedPreferences cityset = null;

        cityset = this.getContext().getSharedPreferences("CITY", Context.MODE_PRIVATE);
